...
//            HttpsURLConnection l_connection = (HttpsURLConnection) new URL("jdbc:mysql://167.99.76.96:3306/auto_recharge_system?characterEncoding=utf8").openConnection();
//            System.out.print(l_connection.connect());;
